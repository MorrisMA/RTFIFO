# 
# Project automation script for RTFIFO 
# 
# Created for ISE version 10.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source RTFIFO.tcl, then you can
...
set myProject "RTFIFO.ise"
set myScript "RTFIFO.tcl"
...
proc add_source_files {} {
   ...
   xfile add "Src/Microprogram-Sources/RTFIFO_uPgm.txt"
   xfile add "Src/RTL/RTFIFO.ucf"
   xfile add "Src/RTL/RTFIFO.v"

   # Set the Top Module as well...
   project set top "RTFIFO"
...
proc set_process_props {} {
   ...
   project set "SmartGuide Filename" "RTFIFO_guide.ncd"
   ...
   project set "Verilog Macros" "Src/Microprogram-Sources/" -process "Synthesize - XST"
